...
import { createSwarmProfile, getActiveSwarm, getSwarmProfile, listSwarmProfiles, updateSwarmProfile, useSwarm } from '@soulvault/node/swarm';
import {
  approveJoinSwarm,
  ...
  setSwarmTreasury,
  watchSwarmEvents,
} from '@soulvault/node/swarm-contract';
