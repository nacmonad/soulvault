...
`)}get variablesInfo(){if(0!==this.uniforms.length)return this.uniforms.map(e=>[[12,10,1,6][["u32","f16","f32","i32"].indexOf(e.type)],e.length??1])}},tq=(e,r)=>new tU(e,r)}),nI=V(()=>{ng(),nb(),nS(),nT(),tW=(e,r)=>0!==r.length?r:[...Array(e).keys()].reverse(),tL=(e,r)=>{let i,a,n=e.dataType,s=e.dims.length,o=tW(s,r),u=(i=e.dims,a=o,e6.sortBasedOnPerm(i,tW(i.length,a))),l=e.dims,d=u;if(s<2||((e,r)=>{let i=0;for(let a=0;a<e.length;++a)if(1!==r[e[a]]){if(e[a]<i)return!1;i=e[a]}return!0})(o,e.dims))return{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let r=e6.size(u);return{outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(r/64/4)},programUniforms:[{type:12,data:Math.ceil(r/4)}]}},getShaderSource:e=>{let r=tM("input",n,l,4),i=tN("output",n,d,4);return`
  ${e.registerUniform("output_size","u32").declareVariables(r,i)}
  ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`}};let{newShape:p,newPerm:c}=((e,r)=>{let i=[],a=[];for(let n=0;n<e.length;++n)1!==e[n]&&i.push(e[n]),1!==e[r[n]]&&a.push(r[n]);return{newShape:i,newPerm:a}})(e.dims,o),h=e6.areEqual(c,[2,3,1]),f=e6.areEqual(c,[3,1,2]);return 2===p.length||h||f?(d=[(l=h?[p[0],p[1]*p[2]]:f?[p[0]*p[1],p[2]]:p)[1],l[0]],{name:"TransposeShared",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let r=e6.size(u);return{outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(d[1]/16),y:Math.ceil(d[0]/16)},programUniforms:[{type:12,data:r},...tE(l,d)]}},getShaderSource:e=>{let r=tM("a",n,l.length),i=tN("output",n,d.length);return`
  ${e.registerUniform("output_size","u32").declareVariables(r,i)}
  ...
  }`}}):{name:"Transpose",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:()=>{let r=e6.size(u);return{outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:[{type:12,data:r},...tE(l,d)]}},getShaderSource:e=>{let r=tM("a",n,l.length),i=tN("output",n,d.length);return`
  ${e.registerUniform("output_size","u32").declareVariables(r,i)}
  ...
  ${e.mainStart()}
    ...
    ${i.setByOffset("global_idx",r.getByIndices("aIndices"))}
  }`}}},tV=(e,r)=>{((e,r)=>{if(!e||1!==e.length)throw Error("Transpose requires 1 input.");if(0!==r.length&&r.length!==e[0].dims.length)throw Error(`perm size ${r.length} does not match input rank ${e[0].dims.length}`)})(e.inputs,r.perm),e.compute(tL(e.inputs[0],r.perm))},tG=e=>tx({perm:e.perm})}),nE=V(()=>{ng(),nb(),nT(),nz(),nI(),tH={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate * candidate",logSumExp:"bestValue + exp(candidate)",l1:"bestValue + abs(candidate)",l2:"bestValue + candidate * candidate",logSum:"bestValue + candidate"},tF={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate",logSumExp:"bestValue + candidate",l1:"bestValue + candidate",l2:"bestValue + candidate",logSum:"bestValue + candidate"},tj={max:"_A[offset]",min:"_A[offset]",mean:"0",sum:"0",prod:"1",sumSquare:"0",logSumExp:"0",l1:"0",l2:"0",logSum:"0"},tK={max:"bestValue",min:"bestValue",sum:"bestValue",prod:"bestValue",sumSquare:"bestValue",logSumExp:"log(bestValue)",l1:"bestValue",l2:"sqrt(bestValue)",logSum:"log(bestValue)"},tZ=(e,r,i,a)=>{var n,s,o,u,l,d,p;let c,h,f,m,g,y,_,b=1===e.inputs.length?i:t9(e.inputs,i),$=b.axes;0!==$.length||b.noopWithEmptyAxes||($=e.inputs[0].dims.map((e,r)=>r));let v=e6.normalizeAxes($,e.inputs[0].dims.length),w=v,x=e.inputs[0],k=((e,r)=>{let i=[];if(!((e,r)=>{for(let i=0;i<e.length;++i)if(e[e.length-i-1]!==r-1-i)return!1;return!0})(e,r)){for(let a=0;a<r;++a)-1===e.indexOf(a)&&i.push(a);e.forEach(e=>i.push(e))}return i})(w,e.inputs[0].dims.length);k.length>0&&(x=e.compute(tL(e.inputs[0],k),{inputs:[0],outputs:[-1]})[0],w=((e,r)=>{let i=[];for(let a=r-e;a<r;++a)i.push(a);return i})(w.length,x.dims.length));let[S,T]=((e,r)=>{let i=[],a=e.length;for(let n=0;n<a;n++)-1===r.indexOf(n)&&i.push(e[n]);return[i,r.map(r=>e[r])]})(x.dims,w),I=S;b.keepDims&&(I=((e,r)=>{let i=e.length+r.length,a=[],n=0;for(let s=0;s<i;s++)-1===r.indexOf(s)?a.push(e[n++]):a.push(1);return a})(S,v)),e.compute((n=r,s=b.cacheKey,o=[x],u=a,l=e.inputs[0].dataType,d=I,p=T,c=o[0].dims,h=e6.size(d),f=e6.size(p),m=tM("_A",o[0].dataType,c),g=tN("output",l,d),y=64,1===h&&(y=256),_=`
       ...
       `,{name:n,shaderCache:{hint:`${s};${y}`,inputDependencies:["type"]},getShaderSource:e=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:d,dataType:l}],dispatchGroup:{x:h},programUniforms:[{type:12,data:f}]})}),{inputs:[x]})},tQ=(e,r)=>{tZ(e,"ReduceMeanShared",r,"mean")},tX=(e,r)=>{tZ(e,"ReduceL1Shared",r,"l1")},tY=(e,r)=>{tZ(e,"ReduceL2Shared",r,"l2")},tJ=(e,r)=>{tZ(e,"ReduceLogSumExpShared",r,"logSumExp")},t0=(e,r)=>{tZ(e,"ReduceMaxShared",r,"max")},t1=(e,r)=>{tZ(e,"ReduceMinShared",r,"min")},t2=(e,r)=>{tZ(e,"ReduceProdShared",r,"prod")},t3=(e,r)=>{tZ(e,"ReduceSumShared",r,"sum")},t4=(e,r)=>{tZ(e,"ReduceSumSquareShared",r,"sumSquare")},t6=(e,r)=>{tZ(e,"ReduceLogSumShared",r,"logSum")}}),nz=V(()=>{ng(),nb(),nS(),nT(),nE(),t8=e=>{if(!e||0===e.length||e.length>2)throw Error("Reduce op requires 1 or 2 inputs.");if(2===e.length&&1!==e[1].dims.length)throw Error("Invalid axes input dims.")},t5=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],t7=(e,r,i,a,n,s,o=!1,u=!1)=>{let l=[],d=i[0].dims,p=d.length,c=e6.normalizeAxes(n,p),h=!u&&0===c.length;d.forEach((e,r)=>{h||c.indexOf(r)>=0?o&&l.push(1):l.push(e)});let f=l.length,m=e6.size(l);return{name:e,shaderCache:r,getShaderSource:e=>{let r=[],n=tM("_A",i[0].dataType,p),u=tN("output",s,f),l=a(n,u,c),m=l[2];for(let e=0,i=0;e<p;e++)h||c.indexOf(e)>=0?(o&&i++,m=`for(var j${e}: u32 = 0; j${e} < ${d[e]}; j${e}++) {
...
`)}
        }`},getRunData:()=>({outputs:[{dims:l,dataType:s}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:[{type:12,data:m},...tE(d,l)]})}},t9=(e,r)=>{let i=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(e=>i.push(Number(e))),tx({axes:i,keepDims:r.keepDims,noopWithEmptyAxes:r.noopWithEmptyAxes})},re=(e,r,i,a)=>{let n=e.inputs,s=1===n.length?i:t9(n,i);e.compute(t7(r,{hint:s.cacheKey,inputDependencies:["rank"]},[n[0]],s.noopWithEmptyAxes&&0===s.axes.length?t5:a,s.axes,n[0].dataType,s.keepDims,s.noopWithEmptyAxes),{inputs:[0]})},rt=(e,r,i)=>{if(0===r.length)return i;let a=1,n=1;for(let i=0;i<r.length;i++)-1===r.indexOf(i)?a*=e[i]:n*=e[i];return n<32&&a>1024},rr=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceMean",a,(e,r,a)=>{let n=1;for(let r=0;r<e.rank;r++)(a.indexOf(r)>=0||0===a.length)&&(n*=i.inputs[0].dims[r]);return["var sum = f32(0);","",`sum += f32(${e.getByIndices("input_indices")});`,`let value = ${r.type.value}(sum / ${n});`]})):tQ(e,r)},ri=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceL1",a,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += abs(${e.getByIndices("input_indices")});`,""])):tX(e,r)},ra=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceL2",a,(e,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${e.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])):tY(e,r)},rn=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceLogSumExp",a,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += exp(${e.getByIndices("input_indices")});`,"value = log(value);"])):tJ(e,r)},rs=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceMax",a,(e,r,i)=>{let a=[];for(let r=0;r<e.rank;r++)(i.indexOf(r)>=0||0===i.length)&&a.push(e.indicesSet("input_indices",r,0));return[`${a.join(`
`)}`,`var value = ${e.getByIndices("input_indices")};`,`value = max(value, ${e.getByIndices("input_indices")});`,""]})):t0(e,r)},ro=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceMin",a,(e,r,i)=>{let a=[];for(let r=0;r<e.rank;r++)(i.indexOf(r)>=0||0===i.length)&&a.push(`input_indices[${r}] = 0;`);return[`${a.join(`
`)}`,`var value = ${e.getByIndices("input_indices")};`,`value = min(value, ${e.getByIndices("input_indices")});`,""]})):t1(e,r)},ru=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceProd",a,(e,r)=>[`var value = ${r.type.storage}(1);`,"",`value *= ${e.getByIndices("input_indices")};`,""])):t2(e,r)},rl=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceSum",a,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${e.getByIndices("input_indices")};`,""])):t3(e,r)},rd=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceSumSquare",a,(e,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${e.getByIndices("input_indices")}; value += t * t;`,""])):t4(e,r)},rp=(e,r)=>{var i,a;rt(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,t8(i.inputs),re(i,"ReduceLogSum",a,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${e.getByIndices("input_indices")};`,"value = log(value);"])):t6(e,r)}}),nC=V(()=>{ng(),nS(),nz(),rc=e=>{if(!e||0===e.length||e.length>2)throw Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(1!==e[0].dataType)throw Error("Invalid input type.")},rh=(e,r)=>{rc(e.inputs),e.compute(t7("ArgMin",{hint:r.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],(e,i,a)=>{let n=[];for(let r=0;r<e.rank;r++)(a.indexOf(r)>=0||0===a.length)&&n.push(`input_indices[${r}] = 0;`);return[`${n.join(`
...
var best_index : i32 = 0;`,`if (${e.getByIndices("input_indices")} ${r.selectLastIndex>0?">=":">"} value) {
         value = ${e.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",i.setByOffset("global_idx","best_index")]},[r.axis],7,r.keepDims),{inputs:[0]})},rm=e=>tx(e)}),nA=V(()=>{ng(),nb(),nx(),nT(),rg=(e,r,i)=>r&&e?`
    ...
    `,ry=(e,r,i,a,n,s,o,u,l,d,p,c)=>{var h,f,m,g,y,_,b,$,v,w,x,k,S,T,I,E,z,C,A,O,R,B,M,N,D;let P,U,q,W,L,V,G,H,F,j,K,Z,Q,X,Y,J,ee,et,er,ei,ea,en,es,eo,eu,el,ed,ep,ec,eh,ef,em,eg,ey=Math.min(e.outputCount,1+ +!!o+ +!!u),e_=ey>1?o:void 0,eb=ey>1?u:void 0,e$=ey>1?d.pastSequenceLength:0,ev=e$+d.kvSequenceLength,ew=l&&e6.size(l.dims)>0?l:void 0,ex=[r,i];e_&&e6.size(e_.dims)>0&&ex.push(e_),ew&&ex.push(ew),p&&ex.push(p),c&&ex.push(c);let ek=e.compute((h=ey,f=r,m=i,g=e_,y=ew,_=d,b=e$,$=p,v=c,P=b+_.kvSequenceLength,U=[_.batchSize,_.numHeads,_.sequenceLength,P],q=h>1&&g,W=_.kvNumHeads?_.kvNumHeads:_.numHeads,L=q?[_.batchSize,W,P,_.headSize]:void 0,V=_.nReps?_.nReps:1,G=0===_.scale?1/Math.sqrt(_.headSize):_.scale,H=tz(_.headSize),F=_.headSize/H,j={x:Math.ceil(P/12),y:Math.ceil(_.sequenceLength/12),z:_.batchSize*_.numHeads},K=[{type:12,data:_.sequenceLength},{type:12,data:F},{type:12,data:P},{type:12,data:_.numHeads},{type:12,data:_.headSize},{type:1,data:G},{type:12,data:b},{type:12,data:_.kvSequenceLength},{type:12,data:V}],Z=q&&g&&e6.size(g.dims)>0,Q=["type","type"],Z&&Q.push("type"),y&&Q.push("type"),$&&Q.push("type"),v&&Q.push("type"),X=[{dims:U,dataType:f.dataType,gpuDataType:0}],q&&X.push({dims:L,dataType:f.dataType,gpuDataType:0}),{name:"AttentionProbs",shaderCache:{hint:`${H};${void 0!==y};${void 0!==g};${h}`,inputDependencies:Q},getRunData:()=>({outputs:X,dispatchGroup:j,programUniforms:K}),getShaderSource:e=>{let r=tM("q",f.dataType,f.dims,H),i=[r,tM("key",m.dataType,m.dims,H)];if(Z){let e=tM("past_key",g.dataType,g.dims,H);i.push(e)}y&&i.push(tM("attention_bias",y.dataType,y.dims));let a=$?tM("seq_lens",$.dataType,$.dims):void 0;a&&i.push(a);let n=v?tM("total_sequence_length_input",v.dataType,v.dims):void 0;n&&i.push(n);let s=tN("output",f.dataType,U),o=[s];q&&o.push(tN("present_key",f.dataType,L,H));let u=tI(1,H);return`
  const TILE_SIZE = 12u;
  ...
  }`}}),{inputs:ex,outputs:ey>1?[-1,1]:[-1]})[0];e.compute((w=ek,x=d.batchSize,k=d.numHeads,S=e$,T=d.sequenceLength,I=ev,E=p,z=c,Y=tz(E?1:I),J=64,(ee=I/Y)<64&&(J=32),et=[{type:12,data:x},{type:12,data:k},{type:12,data:S},{type:12,data:T},{type:12,data:ee},{type:12,data:Math.ceil(I/Y/J)}],er=tT(w.dataType,Y),ei=tI(1,Y),ea=["type"],E&&ea.push("type"),z&&ea.push("type"),{name:"AttentionProbsSoftmax",shaderCache:{hint:`${J};${er};${Y}`,inputDependencies:ea},getShaderSource:e=>{let r=tN("x",w.dataType,w.dims,Y),i=[r],a=E?tM("seq_lens",E.dataType,E.dims):void 0;a&&i.push(a);let n=z?tM("total_sequence_length_input",z.dataType,z.dims):void 0;n&&i.push(n);let s=tI(w.dataType);return`
  ...
  }`},getRunData:()=>({outputs:[],dispatchGroup:{x:1,y:T,z:x*k},programUniforms:et})}),{inputs:p&&c?[ek,p,c]:[ek],outputs:[]});let eS=[ek,a];eb&&e6.size(eb.dims)>0&&eS.push(eb),p&&eS.push(p),c&&eS.push(c),e.compute((C=ey,A=ek,O=a,R=eb,B=d,M=e$,N=p,D=c,en=M+B.kvSequenceLength,es=B.nReps?B.nReps:1,eo=B.vHiddenSize*es,eu=C>1&&R,el=B.kvNumHeads?B.kvNumHeads:B.numHeads,ed=eu?[B.batchSize,el,en,B.headSize]:void 0,ep=[B.batchSize,B.sequenceLength,eo],ec={x:Math.ceil(B.vHeadSize/12),y:Math.ceil(B.sequenceLength/12),z:B.batchSize*B.numHeads},eh=[{type:12,data:B.sequenceLength},{type:12,data:en},{type:12,data:B.vHeadSize},{type:12,data:B.numHeads},{type:12,data:B.headSize},{type:12,data:eo},{type:12,data:M},{type:12,data:B.kvSequenceLength},{type:12,data:es}],ef=eu&&R&&e6.size(R.dims)>0,em=["type","type"],ef&&em.push("type"),N&&em.push("type"),D&&em.push("type"),eg=[{dims:ep,dataType:A.dataType,gpuDataType:0}],eu&&eg.push({dims:ed,dataType:A.dataType,gpuDataType:0}),{name:"AttentionScore",shaderCache:{hint:`${void 0!==R};${C}`,inputDependencies:em},getRunData:()=>({outputs:eg,dispatchGroup:ec,programUniforms:eh}),getShaderSource:e=>{let r=tM("probs",A.dataType,A.dims),i=[r,tM("v",O.dataType,O.dims)];ef&&i.push(tM("past_value",R.dataType,R.dims));let a=N?tM("seq_lens",N.dataType,N.dims):void 0;N&&i.push(a);let n=D?tM("total_sequence_length_input",D.dataType,D.dims):void 0;D&&i.push(n);let s=[tN("output",A.dataType,ep)];return eu&&s.push(tN("present_value",A.dataType,ed)),`
  const TILE_SIZE = 12u;
  ...
  }`,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:a?[{type:12,data:l},...tE(s)]:[{type:12,data:l}]})}})(a,s))}}),nR=V(()=>{nb(),nT(),r$=e=>{var r;let i,a,n,s,o,u,l,d;(e=>{if(3!==e[0].dims.length)throw Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw Error("number of channels should be 320, 640 or 1280");if(1!==e[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw Error("last dimension of input and bias are not the same")})(e.inputs),e.compute((i=(r=e.inputs)[0].dims,a=r[0].dims[2],n=e6.size(i)/4,s=r[0].dataType,o=tM("input",s,i,4),u=tM("bias",s,[a],4),l=tM("residual",s,i,4),d=tN("output",s,i,4),{name:"BiasAdd",getRunData:()=>({outputs:[{dims:i,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:e=>`
  ...
  }`}))}}),nB=V(()=>{ng(),nb(),nS(),nT(),rv=(e,r,i,a,n,s=e.dataType,o,u)=>{let l=[{type:12,data:Math.ceil(e6.size(e.dims)/4)}];return o&&l.push(...o),{name:r,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:r=>{var n,o,l,d,p,c,h;let f,m,g,y,_;return n=r,o=e6.size(e.dims),l=e.dataType,d=s,p=i,c=a,h=u,f=Math.ceil(o/4),m="",m="string"==typeof p?`${p}(a)`:p("a"),g=tM("inputData",l,[f],4),y=tN("outputData",d,[f],4),_=[{name:"vec_size",type:"u32"}],h&&_.push(...h),`
...
`),r.cacheKey,e.inputs[0].dataType))}}),nM=V(()=>{nb(),nT(),nB(),r9=e=>{var r;let i,a,n,s,o,u;(e=>{if(3!==e[0].dims.length)throw Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw Error("hidden state should be 2560, 5120 or 10240");if(1!==e[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw Error("last dimension of input and bias are not the same")})(e.inputs),e.compute(((i=(r=e.inputs)[0].dims.slice())[2]=i[2]/2,a=tM("input",r[0].dataType,r[0].dims,4),n=tM("bias",r[0].dataType,[r[0].dims[2]],4),s=tN("output",r[0].dataType,i,4),o=e6.size(i)/4,u=tT(r[0].dataType),{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:i,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:e=>`
  ...
  ${e.mainStart()}
  ...
  }`}))}}),nN=V(()=>{ng(),nb(),nT(),ie=(e,r,i,a,n,s)=>{e.compute(((e,r,i,a,n,s,o=i.dataType)=>{let u=i.dims.map(Number),l=a.dims.map(Number),d=!e6.areEqual(u,l),p=u,c=e6.size(u),h=!1,f=!1,m=[d];if(d){let e=e4.calcShape(u,l,!1);if(!e)throw Error("Can't perform binary op on the given tensors");p=e.slice(),c=e6.size(p);let r=1===e6.size(u),i=1===e6.size(l),a=u.length>0&&u[u.length-1]%4==0,n=l.length>0&&l[l.length-1]%4==0;m.push(r),m.push(i),m.push(a),m.push(n);let s=1;for(let e=1;e<p.length;e++){let r=u[u.length-e];if(r===l[l.length-e])s*=r;else break}s%4==0?(f=!0,h=!0):(r||i||a||n)&&(h=!0)}else h=!0;return m.push(h),{name:e,shaderCache:{hint:r+m.map(e=>e.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:e=>((e,r,i,a,n,s,o,u,l,d,p,c)=>{let h,f;"string"==typeof u?h=f=(e,r)=>`${u}((${e}),(${r}))`:"function"==typeof u?h=f=u:(h=u.scalar,f=u.vector);let m=tN("outputData",p,a.length,4),g=tM("aData",l,r.length,4),y=tM("bData",d,i.length,4),_;if(n)if(s){let e=1===e6.size(r),a=1===e6.size(i),n=r.length>0&&r[r.length-1]%4==0,s=i.length>0&&i[i.length-1]%4==0;_=e||a?m.setByOffset("global_idx",f(e?`${g.type.value}(${g.getByOffset("0")}.x)`:g.getByOffset("global_idx"),a?`${y.type.value}(${y.getByOffset("0")}.x)`:y.getByOffset("global_idx"))):`
    ...
    fn pow_vector_custom(a : vec4<${r}>, b : vec4<${r}>) -> vec4<${r}> {
      ...
      `)},io=e=>{ie(e,"Sub",(e,r)=>`${e}-${r}`)},iu=e=>{ie(e,"Greater",{scalar:(e,r)=>`u32(${e}>${r})`,vector:(e,r)=>`vec4<u32>(${e}>${r})`},void 0,void 0,9)},il=e=>{ie(e,"Less",{scalar:(e,r)=>`u32(${e}<${r})`,vector:(e,r)=>`vec4<u32>(${e}<${r})`},void 0,void 0,9)},id=e=>{ie(e,"GreaterOrEqual",{scalar:(e,r)=>`u32(${e}>=${r})`,vector:(e,r)=>`vec4<u32>(${e}>=${r})`},void 0,void 0,9)},ip=e=>{ie(e,"LessOrEqual",{scalar:(e,r)=>`u32(${e}<=${r})`,vector:(e,r)=>`vec4<u32>(${e}<=${r})`},void 0,void 0,9)}}),nD=V(()=>{ng(),nb(),nS(),nT(),ic=(e,r)=>{let i=e.inputs,a=i[0].dims,n=e6.normalizeAxis(r.axis,a.length);var s=i,o=n;if(!s||s.length<1)throw Error("too few inputs");let u=s[0],l=u.dataType,d=u.dims.length;s.forEach((e,r)=>{if(0!==r){if(e.dataType!==l)throw Error("input tensors should be one type");if(e.dims.length!==d)throw Error("input tensors should have the same shape");e.dims.forEach((e,r)=>{if(r!==o&&e!==u.dims[r])throw Error("non concat dimensions must match")})}});let p=a.slice();p[n]=i.reduce((e,r)=>e+(r.dims.length>n?r.dims[n]:0),0);let c=i.filter(e=>e6.size(e.dims)>0);e.compute(((e,r,i,a)=>{let n=e6.size(i),s=Array(e.length),o=Array(e.length),u=0,l=[],d=[],p=[{type:12,data:n}];for(let i=0;i<e.length;++i)u+=e[i].dims[r],s[i]=u,d.push(e[i].dims.length),o[i]=tM(`input${i}`,a,d[i]),l.push("rank"),p.push({type:12,data:s[i]});for(let r=0;r<e.length;++r)p.push(...tE(e[r].dims));p.push(...tE(i));let c=tN("output",a,i.length),h=c.indicesGet("indices",r),f=Array.from(Array(s.length).keys()).map(e=>`uniforms.sizeInConcatAxis${e}`).join(",");return{name:"Concat",shaderCache:{hint:`${r}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:p}),getShaderSource:r=>{let i,a;return`
...
`)})(o,c)}
  }`}}})(c,n,p,i[0].dataType),{inputs:c})},ih=e=>tx({axis:e.axis})}),nP=V(()=>{ng(),nb(),im=(e,r,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${r}(0.0));`;case"Sigmoid":return`value = (${r}(1.0) / (${r}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${r}(${i}(uniforms.clip_min)), ${r}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${r}(0.0), min(${r}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${r}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw Error(`Unsupported activation ${e.activation}`)}},ig=(e,r)=>{"Clip"===e.activation?r.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):"HardSigmoid"===e.activation?r.push({type:1,data:e.alpha},{type:1,data:e.beta}):"LeakyRelu"===e.activation&&r.push({type:1,data:e.alpha})},iy=(e,r)=>{"Clip"===e.activation?r.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):"HardSigmoid"===e.activation?r.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):"LeakyRelu"===e.activation&&r.push({name:"alpha",type:"f32"})},i_=e=>{let r=e?.activation||"";if("HardSigmoid"===r){let[i,a]=e?.activation_params||[.2,.5];return{activation:r,alpha:i,beta:a}}if("Clip"===r){let[i,a]=e?.activation_params||[e7,e9];return{activation:r,clipMax:a,clipMin:i}}if("LeakyRelu"===r){let[i]=e?.activation_params||[.01];return{activation:r,alpha:i}}return{activation:r}}}),nU=V(()=>{ib=(e,r)=>{switch(e){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw Error(`${e}-component is not supported.`)}},i$=e=>`
...
`}),nW=V(()=>{ng(),nb(),nT(),nP(),iw=(e,r,i,a,n)=>{let s=a-i;return`
...
`},ix=(e,r,i,a,n=!1,s)=>{let o=e[0].dims,u=e[1].dims,l=o[o.length-2],d=u[u.length-1],p=o[o.length-1],c=tz(d),h=tz(p),f=tz(l),m=e6.size(i)/c/f,g=e.length>2,y=a?a.slice(0,-2):i.slice(0,-2),_=[e6.size(y),l,d],b=[{type:12,data:m},{type:12,data:l},{type:12,data:d},{type:12,data:p}];return ig(r,b),b.push(...tE(y,o,u)),g&&b.push(...tE(e[2].dims)),b.push(...tE(_)),{name:"MatMulNaive",shaderCache:{hint:`${r.activation};${c};${h};${f};${n}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:b}),getShaderSource:a=>{let s=tP("batch_dims",e[0].dataType,y.length),l=tM("a",e[0].dataType,o.length,h),d=tM("b",e[1].dataType,u.length,c),p=tN("output",e[0].dataType,_.length,c),m=tT(p.type.tensor),b=im(r,p.type.value,m),$=[l,d],v="";if(g){let r=n?c:1;$.push(tM("bias",e[2].dataType,e[2].dims.length,r)),v=`${n?`value += bias[col / ${r}];`:`value += ${p.type.value}(bias[row + i]);`}`}let w=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];return iy(r,w),`
...
`}return e})()}
  ...
  `}}}}),nL=V(()=>{ng(),nb(),nT(),nP(),nW(),nU(),ik=(e,r,i="f32",a,n=!1,s=32,o=!1,u=32)=>{let l,d,p,c,h=r[1]*e[1],f=r[0]*e[0],m=n?h:s,g=n?s:h,y=m/r[0],_=s/r[1];if(!((n&&4===y&&4===e[1]||!n&&(3===y||4===y))&&m%r[0]==0&&s%r[1]==0&&4===e[0]))throw Error(`If transposeA ${n} is true, innerElementSize ${y} and workPerThread[1] ${e[1]} must be 4.
...
`},iI=(e,r,i,a,n=!1,s)=>{let o=e[0].dims,u=e[1].dims,l=o.slice(0,-2),d=u.slice(0,-2),p=a?a.slice(0,-2):i.slice(0,-2),c=e6.size(p),h=o[o.length-2],f=o[o.length-1],m=u[u.length-1],g=f%4==0&&m%4==0,y=h<=8?[4,1,1]:[4,4,1],_=[8,8,1],b=[Math.ceil(m/_[0]/y[0]),Math.ceil(h/_[1]/y[1]),Math.ceil(c/_[2]/y[2])],$=g?4:1,v=[...l,h,f/$],w=v.length,x=[...d,f,m/$],k=x.length,S=[c,h,m/$],T=[{type:6,data:h},{type:6,data:m},{type:6,data:f}];ig(r,T),T.push(...tE(p,v,x));let I=["rank","rank"],E=e.length>2;return E&&(T.push(...tE(e[2].dims)),I.push("rank")),T.push(...tE(S)),{name:"MatMul",shaderCache:{hint:`${y};${r.activation};${g};${n}`,inputDependencies:I},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:b[0],y:b[1],z:b[2]},programUniforms:T}),getShaderSource:i=>{let a=p.length,s=tP("batchDims",e[0].dataType,a,1),o=tT(e[0].dataType),u=tM("a",e[0].dataType,w,$),l=tM("b",e[1].dataType,k,$),d=tN("result",e[0].dataType,S.length,$),c=[u,l];if(E){let r=n?$:1;c.push(tM("bias",e[2].dataType,e[2].dims.length,r))}let h=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];iy(r,h);let f=tT(d.type.tensor),m=((e,r,i,a,n=!1)=>{let[s,o,u,l]=a,d=tT(a[0].type.tensor);return`
  ...
  ${g?ik(y,_,o,s):iT(y,_,o,s)}
      ...
      }`,c=[tM("x",e[0].dataType,e[0].dims.length,3===w?1:w),tM("w",e[1].dataType,e[1].dims.length,s)],h=tN("result",e[0].dataType,i.length,s);if(o){let r=tM("bias",e[2].dataType,e[2].dims.length,s);c.push(r),p+=`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${b}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${l} {
          ...
          }`}}}}),nH=V(()=>{ng(),nb(),nT(),nP(),iB=(e,r,i,a)=>{let n=e.length>2,s=n?"value += b[output_channel];":"",o=e[0].dims,u=e[1].dims,l="NHWC"===r.format,d=l?i[3]:i[1],p=d/r.group,c=l&&p>=4?tz(d):1,h=e6.size(i)/c,f=[{type:12,data:h},{type:12,data:r.dilations},{type:12,data:[r.strides[0],r.strides[1]]},{type:12,data:[r.pads[0],r.pads[1]]},{type:12,data:p}];return ig(r,f),f.push(...tE(o,[u[0],u[1],u[2],u[3]/c])),f.push(...tE([i[0],i[1],i[2],i[3]/c])),{name:"GroupedConv",shaderCache:{hint:`${r.cacheKey}_${c}`,inputDependencies:n?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:f}),getShaderSource:a=>{let d=tN("output",e[0].dataType,i.length,c),p=tT(d.type.tensor),h=im(r,d.type.value,p),f=tM("x",e[0].dataType,o.length),m=tM("w",e[1].dataType,u.length,c),g=[f,m];n&&g.push(tM("b",e[2].dataType,e[2].dims,c));let y=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:r.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];iy(r,y);let _=l?`
  ...
  ${a.mainStart()}
    ...
    ${h}
    ${d.setByOffset("global_idx","value")}
  }`}}},iM=(e,r,i,a)=>{let n=e.length>2,s=tz(i[3]),o=tz(i[2]),u=e6.size(i)/s/o,l=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],p=[i[0],i[1],i[2],i[3]/s],c=[{type:12,data:u},{type:6,data:[r.strides[0],r.strides[1]]},{type:6,data:[r.pads[0],r.pads[1]]}];ig(r,c),c.push(...tE(l,d,p));let h=(o-1)*r.strides[1]+d[1];return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${r.cacheKey};${s};${o};${h};${d[0]};${d[1]}`,inputDependencies:n?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c}),getShaderSource:i=>{let a=tN("output",e[0].dataType,p.length,s),u=tT(a.type.tensor),c=im(r,a.type.value,u),f=tM("x",e[0].dataType,l.length,s),m=tM("w",e[1].dataType,d.length,s),g=[f,m];n&&g.push(tM("b",e[2].dataType,e[2].dims,s));let y=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return iy(r,y),`
  ...
  ${i.mainStart()}
  ...
  }`}}}}),nF=V(()=>{nb(),nV(),nG(),nL(),nH(),nP(),nW(),nI(),iN=[2,3,1,0],iD=(e,r)=>{let i=e.kernelShape.slice();i.length<r[1].dims.length-2&&i.push(...Array(r[1].dims.length-2-i.length).fill(0));for(let e=2;e<r[1].dims.length;++e)0===i[e-2]&&(i[e-2]=r[1].dims[e]);let a=e.pads.slice();e8.adjustPadsBasedOnAutoPad(r[0].dims,e.strides,e.dilations,i,a,"NHWC"===e.format,e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:i,pads:a}),n},iP=e=>{let r=i_(e),i=e.format;return{autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],format:i,dilations:e.dilations,group:e.group,kernelShape:e.kernel_shape,pads:e.pads,strides:e.strides,wIsConst:e.w_is_const(),...r,cacheKey:`${e.format};${r.activation};`}},iU=(e,r,i,a)=>{var n,s,o,u,l,d;let p,c,h,f,m,g,y="NHWC"===i.format,_=(n=r[0].dims,s=r[1].dims,o=i.dilations,u=i.pads,l=i.strides,d=y,p=n[0],h=(c=n.slice(d?1:2,d?3:4)).length,f=s[0],m=s.slice(2).map((e,r)=>e+(e-1)*(o[r]-1)),(g=c.map((e,r)=>e+u[r]+u[r+h]).map((e,r)=>Math.floor((e-m[r]+l[r])/l[r]))).splice(0,0,p),g.splice(d?3:1,0,f),g);if(1!==i.group){let n=[r[0]];if(y){let a=e.kernelCustomData.wT??e.compute(tL(r[1],iN),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=a),n.push(a)}else n.push(r[1]);3===r.length&&n.push(r[2]),!e.adapterInfo.isArchitecture("ampere")&&y&&r[1].dims[0]===i.group&&1===r[1].dims[1]&&1===i.dilations[0]&&1===i.dilations[1]?e.compute(iM(n,i,_,a),{inputs:n}):e.compute(iB(n,i,_,a),{inputs:n});return}let b=3===r.length,$=r[0].dims[y?1:2],v=r[0].dims[y?2:3],w=r[0].dims[y?3:1],x=r[1].dims[2],k=r[1].dims[3],S=_[y?1:2],T=_[y?2:3],I=_[y?3:1],E=y&&x===$&&k===v&&0===i.pads[0]&&0===i.pads[1];if(E||1===x&&1===k&&1===i.dilations[0]&&1===i.dilations[1]&&1===i.strides[0]&&1===i.strides[1]&&0===i.pads[0]&&0===i.pads[1]){let n=_[0],s,o,u,l=[];if(y){let a=e.kernelCustomData.wT??e.compute(tL(r[1],iN),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];if(i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=a),E){let e=$*v*w;s=r[0].reshape([1,n,e]),o=a.reshape([1,e,I]),u=[1,n,I]}else s=r[0].reshape([n,$*v,w]),o=a.reshape([1,w,I]),u=[n,S*T,I];l.push(s),l.push(o)}else s=r[0].reshape([n,w,$*v]),o=r[1].reshape([1,I,w]),u=[n,I,S*T],l.push(o),l.push(s);b&&l.push(r[2]);let d=u[2],p=l[0].dims[l[0].dims.length-1];d<8&&p<8?e.compute(ix(l,i,_,u,y,a),{inputs:l}):e.compute(iI(l,i,_,u,y,a),{inputs:l});return}let z=e.kernelCustomData.wT??e.compute(tL(r[1],iN),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=z);let C=[r[0],z];b&&C.push(r[2]);let A=y?S*T:I,O=y?I:S*T,R=x*k*w;e.compute(iE(C,i,_,A,O,R,b,!0,a),{inputs:C})},iq=(e,r)=>{var i,a,n,s,o;if(((e,r)=>{if(!e||2!==e.length&&3!==e.length)throw Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw Error("filter does not have same dimension as input");if(e[0].dims["NHWC"===r.format?e[0].dims.length-1:1]!==e[1].dims[1]*r.group)throw Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(3===e.length&&(1!==e[2].dims.length||e[1].dims[0]!==e[2].dims[0]))throw Error("invalid bias");let i=e[0].dims.length-2;if(r.dilations.length!==i)throw Error(`dilations should be ${i}D`);if(r.strides.length!==i)throw Error(`strides should be ${i}D`);if(r.pads.length!==2*i)throw Error(`pads should be ${2*i}D`);if(0!==r.kernelShape.length&&r.kernelShape.length!==e[1].dims.length-2)throw Error("invalid kernel shape")})(e.inputs,r),3===e.inputs[0].dims.length){let n,s,o,u,l,d,p;i=e,n="NHWC"===(a=r).format,s=[i.inputs[0].reshape(n?[i.inputs[0].dims[0],1,i.inputs[0].dims[1],i.inputs[0].dims[2]]:[i.inputs[0].dims[0],i.inputs[0].dims[1],1,i.inputs[0].dims[2]]),i.inputs[1].reshape([i.inputs[1].dims[0],i.inputs[1].dims[1],1,i.inputs[1].dims[2]])],3===i.inputs.length&&s.push(i.inputs[2]),o=[0,a.pads[0],0,a.pads[1]],u=[1].concat(a.strides),l=[1].concat(a.dilations),d=[1].concat(a.kernelShape),p=iD({...a,pads:o,strides:u,dilations:l,kernelShape:d},s),iU(i,s,p,e=>n?[e[0],e[2],e[3]]:[e[0],e[1],e[3]])}else if(5===e.inputs[0].dims.length){let i,a,u,l;n=e,s=e.inputs,i="NHWC"===(o=r).format?"channelsLast":"channelsFirst",a=iD(o,s),u="NOTSET"===o.autoPad?o.pads:o.autoPad,l=iO(s[0].dims,s[1].dims,o.strides,o.dilations,u,!1,i),n.compute(iR(s,a,l.outShape,[l.filterDepth,l.filterHeight,l.filterWidth],[l.padInfo.front,l.padInfo.top,l.padInfo.left],i))}else{let i=iD(r,e.inputs);iU(e,e.inputs,i)}}}),nj=V(()=>{ng(),n_(),nb(),nT(),iW=(e,r,i)=>{let a=e.length>2,n=r.outputShape,s="NHWC"===r.format,o=r.group,u=e[1].dims,l=u[2]/o,d=u[3],p=s?tz(l):1,c=s&&1===d&&l>=4,h=c?4*Math.floor(l/4):Math.floor(l/p)*p,f=l-h,m=s?tz(d):1,g=s?1===d?p:m:1,y=e6.size(n)/m,_=[Math.ceil(y/64),1,1];e2("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${_}`);let b=["rank","rank"],$=[r.strides[0],r.strides[1]],v=[r.kernelShape[s?1:2],r.kernelShape[s?2:3]],w=[r.dilations[0],r.dilations[1]],x=[v[0]+(r.dilations[0]<=1?0:(r.kernelShape[s?1:2]-1)*(r.dilations[0]-1)),v[1]+(r.dilations[1]<=1?0:(r.kernelShape[s?2:3]-1)*(r.dilations[1]-1))],k=[x[0]-1-Math.floor((r.pads[0]+r.pads[2])/2),x[1]-1-Math.floor((r.pads[1]+r.pads[3])/2)],S=[{type:12,data:y},{type:12,data:$},{type:12,data:v},{type:12,data:w},{type:12,data:x},{type:6,data:k},{type:12,data:h},{type:12,data:l},{type:12,data:d},...tE(e[0].dims,e[1].dims)];return a&&(S.push(...tE(e[2].dims)),b.push("rank")),S.push(...tE(n)),{name:"ConvTranspose2D",shaderCache:{hint:`${r.cacheKey};${p}${g}${m}${c}${f}`,inputDependencies:b},getRunData:()=>({dispatchGroup:{x:_[0],y:_[1],z:_[2]},outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],programUniforms:S}),getShaderSource:r=>{let i=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:$.length},{name:"filter_dims",type:"u32",length:v.length},{name:"dilations",type:"u32",length:v.length},{name:"effective_filter_dims",type:"u32",length:x.length},{name:"pads",type:"i32",length:k.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],o=tT(e[0].dataType),u=s?1:2,l=s?2:3,d=s?3:1,h=tM("W",e[1].dataType,e[1].dims.length,g),y=tM("Dy",e[0].dataType,e[0].dims.length,p),_=[y,h];a&&_.push(tM("bias",e[2].dataType,[n[d]].length,m));let b=tN("result",e[0].dataType,n.length,m),w=`
    ...
    ${w}}`}}}}),nK=V(()=>{nj(),nP(),nI(),iL=(e,r,i,a,n,s)=>(e-1)*r+i+(a-1)*n+1-s,iV=(e,r,i,a,n)=>{let s=Math.floor(e/2);"SAME_UPPER"===r?(i[a]=s,i[n]=e-s):"SAME_LOWER"===r&&(i[a]=e-s,i[n]=s)},iG=(e,r)=>{let i=e.kernelShape.slice();if(0===e.kernelShape.length||0===e.kernelShape.reduce((e,r)=>e*r,1)){i.length=0;for(let e=2;e<r[1].dims.length;++e)i.push(r[1].dims[e])}let a="NHWC"===e.format;i.splice(0,0,r[1].dims[0]),i.splice(a?3:1,0,r[1].dims[1]);let n=e.pads.slice(),s=e.outputShape.slice(),o=e.outputPadding.slice(),u=r[0].dims,l=e.dilations.slice();0===l.reduce((e,r)=>e+r,0)&&(l=Array(r[0].dims.length-2).fill(1));let d=e.strides.slice();0===d.reduce((e,r)=>e+r,0)&&(d=Array(r[0].dims.length-2).fill(1)),((e,r,i,a,n,s,o,u,l,d)=>{let p=e.length-2,c=0===d.length;l.length<p&&l.push(...Array(p-l.length).fill(0));let h=e[0],f=r[u?3:1]*n;for(let n=0,h=e.length-p-!!u;n<p;++n,++h){let u=e[h],f=c?u*o[n]:d[n];iV(iL(u,o[n],s[n],r[h],i[n],f),a,s,n,n+p),c&&d.push(o[n]*(u-1)+l[n]+(r[h]-1)*i[n]+1-s[n]-s[n+p])}d.splice(0,0,h),d.splice(u?3:1,0,f)})(u,i,l,e.autoPad,e.group,n,d,a,o,s);let p=Object.assign({},e);return Object.assign(p,{kernelShape:i,pads:n,outputPadding:o,outputShape:s,dilations:l,strides:d}),p},iH=e=>{let r=i_(e),i=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],n=e.dilations,s=e.group??1,o=e.kernelShape,u=e.pads,l=e.strides,d=e.wIsConst();return{autoPad:a,format:i,dilations:n,group:s,kernelShape:o,outputPadding:e.outputPadding,outputShape:e.outputShape,pads:u,strides:l,wIsConst:d,...r,cacheKey:`${e.format};${r.activation};`}},iF=(e,r,i,a)=>{let n=e.kernelCustomData.wT??e.compute(tL(r[1],[2,3,0,1]),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=n);let s=[r[0],n];3===r.length&&s.push(r[2]),e.compute(iW(s,i,a),{inputs:s})},ij=(e,r)=>{if(((e,r)=>{if(!e||2!==e.length&&3!==e.length)throw Error("Conv requires 2 or 3 inputs");if(4!==e[0].dims.length&&3!==e[0].dims.length)throw Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw Error("filter does not have same dimension as input");if(e[0].dims["NHWC"===r.format?e[0].dims.length-1:1]!==e[1].dims[0])throw Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let i=e[1].dims[1]*r.group;if(3===e.length&&(1!==e[2].dims.length||e[2].dims[0]!==i))throw Error("invalid bias");let a=e[0].dims.length-2;if(r.dilations.reduce((e,r)=>e+r,0)>0&&r.dilations.length!==a)throw Error(`dilations should be ${a}D`);if(r.strides.reduce((e,r)=>e+r,0)>0&&r.strides.length!==a)throw Error(`strides should be ${a}D`);if(r.pads.reduce((e,r)=>e+r,0)>0&&r.pads.length!==2*a)throw Error(`pads should be ${2*a}D`);if(r.outputPadding.length!==a&&0!==r.outputPadding.length)throw Error(`output_padding should be ${a}D`);if(r.kernelShape.reduce((e,r)=>e+r,0)>0&&0!==r.kernelShape.length&&r.kernelShape.length!==e[1].dims.length-2)throw Error("invalid kernel shape");if(0!==r.outputShape.length&&r.outputShape.length!==e[0].dims.length-2)throw Error("invalid output shape")})(e.inputs,r),3===e.inputs[0].dims.length){var i,a;let n,s,o,u,l,d,p,c;i=e,n="NHWC"===(a=r).format,s=[i.inputs[0].reshape(n?[i.inputs[0].dims[0],1,i.inputs[0].dims[1],i.inputs[0].dims[2]]:[i.inputs[0].dims[0],i.inputs[0].dims[1],1,i.inputs[0].dims[2]]),i.inputs[1].reshape([i.inputs[1].dims[0],i.inputs[1].dims[1],1,i.inputs[1].dims[2]])],3===i.inputs.length&&s.push(i.inputs[2]),(0===(o=a.kernelShape).length||0===o[0])&&(o=[i.inputs[1].dims[2]]),(0===(u=a.dilations).length||0===u[0])&&(u=[1]),(0===(l=a.strides).length||0===l[0])&&(l=[1]),0===(d=a.pads).length&&(d=[0,0]),d=[0,d[0],0,d[1]],l=[1].concat(l),u=[1].concat(u),o=[1].concat(o),p=[0].concat(p=a.outputPadding),c=iG({...a,pads:d,strides:l,dilations:u,kernelShape:o,outputPadding:p},s),iF(i,s,c,e=>n?[e[0],e[2],e[3]]:[e[0],e[1],e[3]])}else{let i=iG(r,e.inputs);iF(e,e.inputs,i)}}}),nZ=V(()=>{ng(),nb(),nS(),nT(),iK=(e,r)=>{var i,a,n,s;let o,u,l,d,p,c,h=e.inputs[0].dims,f=e.inputs[0].dataType,m=e.inputs[1];e.compute((i=f,a=h,n=m,s=r,o=e6.size(a),u=a.length,l=tM("input",i,u),d=tN("output",i,u),p=6===n.dataType?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),c=e6.normalizeAxis(p,u),{name:"CumSum",shaderCache:{hint:s.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:a,dataType:i}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:c},...tE(a,a)]}),getShaderSource:e=>{let r=` i32(${l.indicesGet("inputIndices","uniforms.axis")}) `,i=tR("uniforms.input_shape","uniforms.axis",u),a=s.reverse?r+(s.exclusive?" + 1":""):"0",n=s.reverse?i:r+(s.exclusive?"":" + 1");return`
                ...
                }`}}),{inputs:[0]})},iZ=e=>{let r=1===e.exclusive,i=1===e.reverse;return tx({exclusive:r,reverse:i})}}),nQ=V(()=>{ng(),nb(),nS(),nT(),iQ=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y,_;(e=>{if(!e||1!==e.length)throw Error("DepthToSpace requires 1 input.");if(4!==e[0].dims.length)throw Error("DepthToSpace requires 4D input.")})(e.inputs),e.compute((i=e.inputs[0],p="NHWC"===(a=r).format,c=a.blocksize,h="DCR"===a.mode,p?([n,s,o,u]=i.dims,l=h?[n,s,o,c,c,u/c**2]:[n,s,o,u/c**2,c,c],d=h?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([n,s,o,u]=[i.dims[0],i.dims[2],i.dims[3],i.dims[1]],l=h?[n,c,c,u/c**2,s,o]:[n,u/c**2,c,c,s,o],d=h?[0,3,4,1,5,2]:[0,1,4,2,5,3]),m=(f=i.reshape(l)).dims.length,g=i.dataType,y=tM("a",g,m),_=tN("output",g,m),{name:"DepthToSpace",shaderCache:{hint:`${i.dims};${a.blocksize};${a.mode}`,inputDependencies:["rank"]},getRunData:e=>{let r=p?[n,s*c,o*c,u/c**2]:[n,u/c**2,s*c,o*c],i=e6.size(r),a=f.dims,l=e6.sortBasedOnPerm(a,d);return{outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},...tE(a,l)]}},getShaderSource:e=>`
...
`)};
          ...
          }`}}))},i6=e=>{let r=e.equation.replace(/\s+/g,"");return tx({equation:r})}}),nY=V(()=>{ng(),nb(),nT(),i8=(e,r)=>{let i=e.length-r.length,a=[];for(let r=0;r<i;++r)a.push(e[r]);for(let n=0;n<r.length;++n)a.push(1===r[n]?e[n+i]:r[n]);return a},i5=e=>{var r;let i,a,n,s,o,u,l,d,p,c;(e=>{if(!e||2!==e.length)throw Error("Expand requires 2 input.");let r=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),a=i.length<r.length?0:i.length-r.length,n=r.length<i.length?0:r.length-i.length;for(;a<i.length&&n<r.length;++a,++n)if(i[a]!==r[n]&&1!==i[a]&&1!==r[n])throw Error("Expand requires shape to be broadcastable to input")})(e.inputs),e.compute((s=(i=n=(r=e.inputs)[0].dims,a=Array.from(r[1].getBigInt64Array(),Number),i.length>a.length?i8(i,a):i8(a,i)),u=9===(o=r[0].dataType)||1===e6.size(n),l=9===o||n.length>0&&n[n.length-1]%4==0?4:1,d=u||s.length>0&&s[s.length-1]%4==0?4:1,c=[{type:12,data:p=Math.ceil(e6.size(s)/d)},...tE(n,s)],{name:"Expand",shaderCache:{hint:`${s.length};${l}${d}`,inputDependencies:["rank"]},getShaderSource:e=>{let r=tM("input",o,n.length,l),i=tN("output",o,s.length,d),a;if(9===o){let e=(e,a,n="")=>`
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
    ${a}`},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:c})}),{inputs:[0]})}}),nJ=V(()=>{ng(),nb(),nT(),nB(),i7=e=>{var r;let i,a,n,s;e.inputs.length<2||0===e6.size(e.inputs[1].dims)?r4(e):e.compute((i=(r=e.inputs)[0].dataType,a=e6.size(r[0].dims),s=(n=e6.size(r[1].dims))%4==0,{name:"FastGeluWithBias",shaderCache:{hint:`${s}`,inputDependencies:["type","type"]},getShaderSource:e=>{let r=tM("x",i,[1],4),a=tM("bias",i,[1],4),n=tN("y",i,[1],4),o=e=>`
    ...
    ${e.mainStart(tk)}
      ...
      ${u}
      let x_in = x + bias;
      ${n.setByOffset("global_idx",r3("x_in"))}
    }`},getRunData:e=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],programUniforms:[{type:12,data:Math.ceil(a/4)},{type:12,data:n}],dispatchGroup:{x:Math.ceil(a/tk/4)}})}))}}),n0=V(()=>{ng(),nb(),nS(),nT(),i9=e=>tx({axis:e.axis}),ae=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h;(e=>{if(!e||2!==e.length)throw Error("Gather requires 2 inputs.")})(e.inputs),e.compute((i=e.inputs,a=r,n=i[0].dims,s=i[1].dims,o=n.length,u=e6.normalizeAxis(a.axis,o),(l=n.slice(0)).splice(u,1,...s),d=n[u],p=9===i[0].dataType?4:1,h=[{type:12,data:c=Math.ceil(e6.size(l)/p)},{type:6,data:d},{type:12,data:u},...tE(i[0].dims,i[1].dims,l)],{name:"Gather",shaderCache:{hint:a.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:i[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:h}),getShaderSource:e=>{let r=tM("data",i[0].dataType,i[0].dims.length,p),a=tM("inputIndices",i[1].dataType,i[1].dims.length),n=tN("output",i[0].dataType,l.length,p),d=e=>{let i=s.length,n=`var indicesIndices${e}  = ${a.type.indices}(0);`;for(let r=0;r<i;r++)n+=`${i>1?`indicesIndices${e}[${r}]`:`indicesIndices${e}`} = ${l.length>1?`outputIndices${e}[uniforms.axis + ${r}]`:`outputIndices${e}`};`;n+=`
      ...
      ${e.mainStart()}
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        ${c}
      }`}}))}}),n1=V(()=>{ng(),nb(),nT(),at=(e,r)=>{var i,a,n,s,o,u;let l,d,p=e.inputs,c=p[0].dims,h=p[0].dataType,f=p[1].dims,m=f[f.length-1],g=e6.sizeToDimension(f,f.length-1),y=e6.sizeFromDimension(c,r.batchDims+m),_=e6.sizeToDimension(c,r.batchDims),b=e6.sizeFromDimension(c,r.batchDims),$=Array(m),v=y;for(let e=0;e<m;++e)$[m-1-e]=v,v*=c[r.batchDims+m-1-e];let w=(i=e,a=p[1],n=$,s=r.batchDims,o=c,l=[{type:12,data:u=g},{type:12,data:s},{type:12,data:o},{type:12,data:n},{type:12,data:g/_},{type:12,data:b},{type:12,data:m}],d=[u],l.push(...tE(a.dims,d)),i.compute({name:"computeSliceOffsets",shaderCache:{hint:`${o.length}_${n.length}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:d,dataType:i.inputs[1].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:e=>{let r=tM("indices_data",a.dataType,a.dims.length),i=tN("input_slice_offsets_data",12,1,1),s=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:o.length},{name:"sizes_from_slice_dims_data",type:"u32",length:n.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
  ...
  ${e.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
  }`}},{inputs:[a],outputs:[-1]})[0]),x=r.batchDims+m;if(x>c.length)throw Error("last dimension of indices must not be larger than rank of input tensor");let k=f.slice(0,-1).concat(c.slice(x)),S=e6.size(k),T=[{type:12,data:S},{type:12,data:y},...tE(p[0].dims,w.dims,k)];e.compute({name:"GatherND",shaderCache:{hint:r.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:k,dataType:h}],dispatchGroup:{x:Math.ceil(S/64)},programUniforms:T}),getShaderSource:e=>{let r=tM("data",p[0].dataType,p[0].dims.length),i=tM("slice_offsets",12,w.dims.length),a=tN("output",p[0].dataType,k.length);return`
          ${e.registerUniform("output_size","u32").registerUniform("slice_size","u32").declareVariables(r,i,a)}
            ${e.mainStart()}
            ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
          let slice_offset = slice_offsets[global_idx / uniforms.slice_size];
          output[global_idx] = data[u32(slice_offset) + global_idx % uniforms.slice_size];
        }`}},{inputs:[p[0],w]})},ar=e=>({batchDims:e.batch_dims,cacheKey:""})}),n2=V(()=>{ng(),nb(),nS(),nT(),ai=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f;((e,r)=>{if(e.length<3||e.length>4)throw Error("GatherBlockQuantized requires 3 or 4 inputs.");let i=e6.normalizeAxis(r.quantizeAxis,e[0].dims.length),a=r.blockSize,n=e[0],s=e[2],o=4===e.length?e[3]:void 0;if(s.dims.length!==n.dims.length||!n.dims.map((e,r)=>r===i?Math.ceil(e/a)===s.dims[r]:e===s.dims[r]).reduce((e,r)=>e&&r,!0))throw Error("Scales must have the same rank as the input tensor and the dims should match except on gatherAxis.");if(o){if(o.dataType!==n.dataType)throw Error("Zero point must have the same data type as the input tensor.");if(o.dims.length!==s.dims.length||!o.dims.map((e,r)=>e===s.dims[r]).reduce((e,r)=>e&&r,!0))throw Error("Zero point must have the same rank as the input tensor and the dims should match except on quantizeAxis.")}})(e.inputs,r),e.compute((i=e.inputs,a=r,n=i[0].dims,s=i[1].dims,o=n.length,u=e6.normalizeAxis(a.gatherAxis,o),l=e6.normalizeAxis(a.quantizeAxis,o),(d=n.slice(0)).splice(u,1,...s),p=e6.size(d),c=i[2].dataType,h=22===i[0].dataType,f=[{type:12,data:p},{type:12,data:l},{type:12,data:u},{type:12,data:a.blockSize},...tE(...i.map((e,r)=>e.dims),d)],{name:"GatherBlockQuantized",shaderCache:{hint:`${a.cacheKey};${i.filter((e,r)=>1!==r).map(e=>e.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:i.length},(e,r)=>"rank")},getRunData:()=>({outputs:[{dims:d,dataType:c}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:f}),getShaderSource:e=>{let r=tM("data",i[0].dataType,i[0].dims.length),a=tM("inputIndices",i[1].dataType,i[1].dims.length),o=tM("scales",i[2].dataType,i[2].dims.length),l=i.length>3?tM("zeroPoint",i[3].dataType,i[3].dims.length):void 0,p=tN("output",c,d.length),f=[r,a,o];return l&&f.push(l),`
        ...
        let dequantized_data = ${tI(c)}(quantized_data - zero_point) * scale;
        ${p.setByOffset("global_idx","dequantized_data")};
    }`}}))},aa=e=>tx({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),n3=V(()=>{ng(),nb(),nS(),nT(),an=e=>tx({axis:e.axis}),as=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y;(e=>{if(!e||2!==e.length)throw Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)})(e.inputs),e.compute((i=e.inputs,a=r,n=i[0].dims,s=i[0].dataType,o=n.length,u=i[1].dims,l=i[1].dataType,p=n[d=e6.normalizeAxis(a.axis,o)],c=u.slice(0),h=e6.size(c),f=tM("input",s,o),m=tM("indicesInput",l,u.length),g=tN("output",s,c.length),(y=[{type:12,data:h},{type:6,data:p},{type:12,data:d}]).push(...tE(n,u,c)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:c,dataType:i[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:y}),getShaderSource:e=>`
      ...
      ${g.setByOffset("global_idx","value")};
  }`}))}}),n4=V(()=>{ng(),nb(),nT(),ao=e=>({transA:e.transA,transB:e.transB,alpha:e.alpha,beta:e.beta,cacheKey:`${e.transA};${e.transB};${1===e.alpha}`}),au=(e,r)=>{(e=>{if(!e)throw Error("Input is missing");if(e.length<2||e.length>3)throw Error("Invaid input number.");if(3===e.length&&e[2].dims.length>2)throw Error("Invalid input shape of C");if(e[0].dataType!==e[1].dataType||3===e.length&&e[0].dataType!==e[2].dataType)throw Error("Input types are mismatched")})(e.inputs),e.compute(((e,r)=>{let i=e[0].dims.slice(),a=e[1].dims.slice(),[n,s,o]=e5.getShapeOfGemmResult(i,r.transA,a,r.transB,3===e.length?e[2].dims:void 0),u=[n,s];if(!u)throw Error("Can't use gemm on the given tensors");let l=Math.ceil(s/16),d=Math.ceil(n/16),p=(e6.size(u),[{type:12,data:l},{type:12,data:n},{type:12,data:s},{type:12,data:o},{type:1,data:r.alpha},{type:1,data:r.beta}]),c=["type","type"];return 3===e.length&&(p.push(...tE(e[2].dims)),c.push("rank")),p.push(...tE(u)),{name:"GemmShared",shaderCache:{hint:`${r.cacheKey}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:l*d},programUniforms:p}),getShaderSource:i=>{let a=tM("a",e[0].dataType,e[0].dims),n=tM("b",e[1].dataType,e[1].dims),s=null,o=[a,n];3===e.length&&(s=tM("c",e[2].dataType,e[2].dims.length),o.push(s));let l=tN("output",e[0].dataType,u.length);o.push(l);let d="",p="";r.transA&&r.transB?(p=`
  ...
  }`}}})(e.inputs,r))}}),n6=V(()=>{ng(),nb(),nS(),nT(),[al,ad,ap,ac]=[0,1,2,3],ah=`
...
`,af=(e,r)=>{var i,a;let n,s,o,u,l,d,p;(e=>{if(4!==e[0].dims.length)throw Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw Error("grid batch size must match input batch size")})(e.inputs),e.compute((i=e.inputs,a=r,n=tM("x",i[0].dataType,i[0].dims.length),s=[i[1].dims[0],i[1].dims[1],i[1].dims[2]],o=tM("grid",i[1].dataType,s.length,2),u=[i[0].dims[0],i[0].dims[1],i[1].dims[1],i[1].dims[2]],"NHWC"===a.format&&(u=[i[0].dims[0],i[1].dims[1],i[1].dims[2],i[0].dims[3]],[al,ad,ap,ac]=[0,3,1,2]),l=tN("output",i[0].dataType,u.length),d=n.type.value,p=[{type:12,data:e6.size(u)},...tE(i[0].dims,s,u)],{name:"GridSample",shaderCache:{hint:`${a.cacheKey}`,inputDependencies:["type","type"]},getRunData:e=>{let r=e6.size(u);return{outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:p}},getShaderSource:e=>{let r,i,s,u,p,c,h,f,m;return`
...
`}
  ...
  }`}}))},am=e=>tx({alignCorners:e.align_corners,mode:e.mode,paddingMode:e.padding_mode,format:e.format})}),n8=V(()=>{ng(),nb(),nS(),nx(),nA(),nT(),nI(),ag=(e,r)=>e.length>r&&e[r].dims.length>0?e[r]:void 0,ay=e=>tx({...e}),a_=tx({perm:[0,2,1,3]}),ab=(e,r,i,a,n,s,o,u)=>{var l,d,p,c,h,f,m;let g,y,_,b=s;if(!(o&&e6.size(o.dims)>0))return 3===s.dims.length&&(b=s.reshape([r,a,i,n])),1===i||1===a?b:e.compute(tL(b,a_.perm),{inputs:[b],outputs:[-1]})[0];if(1===a)throw Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return b=(l=e,d=s,p=o,c=r,h=a,f=i*n,m=u,g=[c,h,f],_=[{type:12,data:y=e6.size(g)},{type:12,data:m},{type:12,data:f}],b=l.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:g,dataType:d.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(y/64)},programUniforms:_}),getShaderSource:e=>{let r=tN("qkv_with_bias",d.dataType,g),i=tM("qkv",d.dataType,g),a=tM("bias",p.dataType,g);return`
...
`)}
  ...
  }`},getRunData:()=>({outputs:d,dispatchGroup:{x:Math.ceil(a/64)},programUniforms:h})}},aw=(e,r)=>{let i,a;var n,s,o=e.inputs;if(!o||o.length<1)throw Error("too few inputs");let u=1===e.inputs.length?r:(n=e.inputs,i=[],a=(s=r).numOutputs,n[1].dims[0]>0&&(n[1].getBigInt64Array().forEach(e=>i.push(Number(e))),a=i.length),tx({numOutputs:a,axis:s.axis,splitSizes:i}));e.compute(av(e.inputs,u),{inputs:[0]})},ax=e=>{let r=e.axis,i=e.splitSizes,a=e.numOutputs<0?i.length:e.numOutputs;if(a!==i.length)throw Error("numOutputs and splitSizes length must be equal");return tx({axis:r,numOutputs:a,splitSizes:i})}}),n7=V(()=>{ng(),nb(),nS(),nT(),ak=(e,r)=>{let{interleaved:i,numHeads:a,rotaryEmbeddingDim:n,scale:s}=r,o=e[0].dims[0],u=e6.sizeFromDimension(e[0].dims,1),l=e[0].dims[e[0].dims.length-2],d=u/l,p=e[2].dims[1],c=0===n?2*p:d/a,h=[o,l,d/c,c-p],f=e6.computeStrides(h),m=[{type:1,data:s},{type:12,data:h},{type:12,data:f},...3===e[0].dims.length?Array({type:12,data:[u,d,c,1]}):[],...4===e[0].dims.length?Array({type:12,data:[u,c,l*c,1]}):[],...tE(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)];return{name:"RotaryEmbedding",shaderCache:{hint:tx({interleaved:i}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:r=>{let a=tM("input",e[0].dataType,e[0].dims.length),n=tM("position_ids",e[1].dataType,e[1].dims.length),s=tM("cos_cache",e[2].dataType,e[2].dims.length),o=tM("sin_cache",e[3].dataType,e[3].dims.length),u=tN("output",e[0].dataType,e[0].dims.length);return r.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:h.length},{name:"global_strides",type:"u32",length:f.length},{name:"input_output_strides",type:"u32",length:f.length}]),`
  ...
  `}}),{inputs:[l,d],outputs:[-1]})[0],u=e.inputs[7],p=e.inputs[8],c=tx({interleaved:0!==r.rotaryInterleaved,numHeads:i.numHeads,rotaryEmbeddingDim:0,scale:r.scale}),m=[h,o,u,p],w=[-1];g=e.compute(ak(m,c),{inputs:m,outputs:w})[0],m.splice(0,1,f);let x=tx({interleaved:0!==r.rotaryInterleaved,numHeads:i.kvNumHeads,rotaryEmbeddingDim:0,scale:r.scale});y=e.compute(ak(m,x),{inputs:m,outputs:w})[0]}let w=ab(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,r.doRotary?g:h,void 0,0),x=aI(e,r.doRotary?y:f,i),k=aI(e,m,i);ry(e,w,x,k,void 0,void 0,o,u,void 0,i,l,d)}}),se=V(()=>{ng(),nb(),nI(),nT(),az=(e,r,i,a,n,s,o,u)=>{let l=tz(s),d=1===l?"f32":`vec${l}f`,p=1===l?"vec2f":`mat2x${l}f`,c=n*o,h=64;1===c&&(h=256);let f=[n,o,s/l],m=[n,o,2],g=[];return g.push(...tE(f,m)),e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${l};${u};${h}`,inputDependencies:["rank","type","type"]},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:c},programUniforms:g}),getShaderSource:e=>{let n=tM("x",r.dataType,3,l),s=[n,tM("scale",i.dataType,i.dims),tM("bias",a.dataType,a.dims),tN("output",1,3,2)];return`
  ...
  }`}},{inputs:[r[0],f]})})(e,e.inputs,r):(i=e,a=e.inputs,n=r,o=(s=a[0].dims)[0],u=s[1],l=e6.sizeFromDimension(s,2),d=tz(l),p=e6.size(s)/d,c=az(i,a[0],a[1],a[2],o,l,u,n.epsilon),h=[o,u,l/d],f=[o,u],i.compute({name:"InstanceNormalization",shaderCache:{hint:`${d}`,inputDependencies:["type","none"]},getRunData:()=>({outputs:[{dims:s,dataType:a[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:[{type:12,data:p},...tE(h,f,h)]}),getShaderSource:e=>{let r=tM("x",a[0].dataType,h.length,d),i=tM("scale_shift",1,f.length,2),n=tN("output",a[0].dataType,h.length,d),s=[r,i,n];return`
  ...
  ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${n.setByOffset("global_idx","value")};
  }`}},{inputs:[a[0],c]}))}}),st=V(()=>{ng(),nb(),nT(),aA=(e,r)=>{(e=>{if(!e||e.length<2)throw Error("layerNorm requires at least 2 inputs.")})(e.inputs),e.compute(((e,r,i)=>{let a=r.simplified,n=e[0].dims,s=e[1],o=!a&&e[2],u=e6.normalizeAxis(r.axis,n.length),l=e6.sizeToDimension(n,u),d=e6.sizeFromDimension(n,u),p=e6.size(s.dims),c=o?e6.size(o.dims):0;if(p!==d||o&&c!==d)throw Error(`Size of X.shape()[axis:] == ${d}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${p} and bias size of ${c}`);let h=[];for(let e=0;e<n.length;++e)e<u?h.push(n[e]):h.push(1);let f=tz(d),m=["type","type"],g=[{type:12,data:l},{type:1,data:d},{type:12,data:Math.floor(d/f)},{type:1,data:r.epsilon}];o&&m.push("type");let y=i>1,_=i>2,b=[{dims:n,dataType:e[0].dataType}];return y&&b.push({dims:h,dataType:1}),_&&b.push({dims:h,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${f};${i};${a}`,inputDependencies:m},getRunData:()=>({outputs:b,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:g}),getShaderSource:r=>{let i=tT(e[0].dataType),u=[tM("x",e[0].dataType,e[0].dims,f),tM("scale",s.dataType,s.dims,f)];return o&&u.push(tM("bias",o.dataType,o.dims,f)),u.push(tN("output",e[0].dataType,n,f)),y&&u.push(tN("mean_data_output",1,h)),_&&u.push(tN("inv_std_output",1,h)),`
  ...
  ${r.mainStart()}
    ...
    ${_?"inv_std_output[global_idx] = inv_std_dev":""};
  }`}}})(e.inputs,r,e.outputCount))}}),sr=V(()=>{nb(),nW(),nL(),aO=e=>{var r=e.inputs;if(!r||2!==r.length)throw Error("MatMul requires 2 inputs.");if(r[0].dims[r[0].dims.length-1]!==r[1].dims[r[1].dims.length-2])throw Error("shared dimension does not match.");let i=e4.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!i)throw Error("Can't use matmul on the given tensors");let a=i[i.length-1],n=e.inputs[0].dims[e.inputs[0].dims.length-1];if(a<8&&n<8)e.compute(ix(e.inputs,{activation:""},i));else{let r=i[i.length-2],s=e6.size(e.inputs[0].dims.slice(0,-2)),o=e6.size(e.inputs[1].dims.slice(0,-2));if(1!==s&&1===r&&1===o){let r=e.inputs[0].reshape([1,s,n]),o=e.inputs[1].reshape([1,n,a]),u=[1,s,a],l=[r,o];e.compute(iI(l,{activation:""},i,u),{inputs:l})}else e.compute(iI(e.inputs,{activation:""},i))}}}),si=V(()=>{ng(),nb(),nS(),nT(),aR=(e,r)=>{var i,a,n,s;let o,u,l,d,p,c,h,f,m,g,y,_,b,$,v,w,x,k,S,T,I,E,z,C,A,O,R,B,M,N,D,P,U,q,W,L,V,G,H,F,j,K;((e,r)=>{if(e.length<3||e.length>4)throw Error("MatMulNBits requires 3 or 4 inputs");let i=e[0],a=i.dims.length;if(i.dims[a-1]!==r.k)throw Error("The last dim of input shape does not match the k value");let n=Math.floor((r.k+r.blockSize-1)/r.blockSize),s=r.blockSize/8*r.bits,o=e[1];if(!e6.areEqual(o.dims,[r.n,n,s]))throw Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let u=e[2].dims;if(e6.size(u)!==r.n*n)throw Error("scales input size error.");if(4===e.length){let i=e[3].dims,a=r.n*(8===r.bits?n:Math.floor((n*r.bits+7)/8));if(e6.size(i)!==a)throw Error("zeroPoints input size error.")}})(e.inputs,r),32===r.blockSize&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute((i=e.inputs,a=r,u=(o=i[0].dims).length,l=o[u-2],d=a.k,p=a.n,c=o.slice(0,u-2),h=e6.size(c),f=i[1].dims[2]/4,m=i[0].dataType,g=tz(a.k),y=tz(f),_=c.concat([l,p]),$=128/(b=p%8==0?8:p%4==0?4:1),x=(w=$*y*(v=Math.floor(32/a.bits)))/g,k=w/a.blockSize,S=e6.size(_)/b,T=[],I=[h,l,d/g],(E=e6.convertShape(i[1].dims).slice()).splice(-1,1,f/y),T.push(...tE(I)),T.push(...tE(E)),T.push(...tE(i[2].dims)),4===i.length&&T.push(...tE(e6.convertShape(i[3].dims))),z=[h,l,p],T.push(...tE(z)),{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${a.blockSize};${g};${y};${$};${b}`,inputDependencies:Array(i.length).fill("rank")},getRunData:()=>({outputs:[{dims:_,dataType:m}],dispatchGroup:{x:S},programUniforms:T}),getShaderSource:e=>{let r=I.length,n=tM("a",i[0].dataType,r,g),s=tM("b",12,E.length,y),o=tM("scales",i[2].dataType,i[2].dims.length),u=[n,s,o],l=4===i.length?tM("zero_points",12,i[3].dims.length):void 0;l&&u.push(l);let d=z.length,p=tN("output",i[0].dataType,d),c=tT(i[0].dataType),h=()=>{switch(g){case 1:return`
        ...
        }`}})):e.compute((n=e.inputs,s=r,A=(C=n[0].dims).length,O=C[A-2],R=s.k,B=s.n,M=C.slice(0,A-2),N=e6.size(M),D=n[1].dims[2]/4,P=n[0].dataType,U=tz(s.k),q=tz(D),W=tz(B),L=M.concat([O,B]),V=O>1&&B/W%2==0?2:1,G=e6.size(L)/W/V,H=[],F=[N,O,R/U],(j=e6.convertShape(n[1].dims).slice()).splice(-1,1,D/q),H.push(...tE(F)),H.push(...tE(j)),H.push(...tE(n[2].dims)),4===n.length&&H.push(...tE(e6.convertShape(n[3].dims))),K=[N,O,B/W],H.push(...tE(K)),{name:"MatMulNBits",shaderCache:{hint:`${s.blockSize};${s.bits};${U};${q};${W};${V};64`,inputDependencies:Array(n.length).fill("rank")},getRunData:()=>({outputs:[{dims:L,dataType:P}],dispatchGroup:{x:G},programUniforms:H}),getShaderSource:e=>{let r=F.length,i=tM("a",n[0].dataType,r,U),a=tM("b",12,j.length,q),o=tM("scales",n[2].dataType,n[2].dims.length),u=[i,a,o],l=4===n.length?tM("zero_points",12,n[3].dims.length):void 0;l&&u.push(l);let d=K.length,p=tN("output",n[0].dataType,d,W),c=tT(n[0].dataType),h=(()=>{switch(U){case 1:return`array<${c}, 8>`;case 2:return`mat4x2<${c}>`;case 4:return`mat2x4<${c}>`;default:throw Error(`${U}-component is not supported.`)}})(),f=Math.floor(32/s.bits),m=Math.floor(f/8);return`
        ...
        ${e.mainStart([64,1,1])}
          ...
          for (var block = local_id.x; block < nBlocksPerCol; block += 64) {
            ...
            for (var word: u32 = 0; word < ${D}; word += ${q}) {
              ${(()=>{let e=`col_index = col * ${W};`;for(let r=0;r<W*V;r++)e+=`
          ...
          `;for(let i=0;i<W*V;i++)e+=`
            ...
            workgroup_shared[local_id.x * ${V} + ${Math.floor(i/W)}]${W>1?`[${i%W}]`:""} += ${Array.from({length:8/U},(e,i)=>`${1===U?`a_data${r>0?r:""}[${i}] * b_dequantized_values[${i}]`:`dot(a_data${r>0?r:""}[${i}], b_dequantized_values[${i}])`}`).join(" + ")};
          `}return e})()}
                word_offset += ${f/U};
              }
            }
        ...
        }`}}))},aB=e=>tx(e)}),sa=V(()=>{ng(),nb(),nT(),aM=(e,r)=>{let i,a,n,s;var o,u,l=e.inputs;if(!l||l.length<1)throw Error("Too few inputs");if(1!==l[0].dataType&&10!==l[0].dataType)throw Error("Input type must be float or float16.");if(l.length>=2){let e=2*l[0].dims.length===l[1].dims[0];if(4===l.length&&(e=2*l[3].dims[0]===l[1].dims[0]),!e)throw Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}let d=((e,r)=>{if(!(e.length>1))return r;{let i=e[1].getBigInt64Array(),a=e.length>=3&&e[2].data?10===e[2].dataType?e[2].getUint16Array()[0]:e[2].getFloat32Array()[0]:0,n=e[0].dims.length,s=new Int32Array(2*n).fill(0);if(e.length>=4){let r=e[3].getBigInt64Array();for(let e=0;e<r.length;e++)s[Number(r[e])]=Number(i[e]),s[Number(r[e])+n]=Number(i[e+r.length])}else i.forEach((e,r)=>s[Number(r)]=Number(e));let o=[];return s.forEach(e=>o.push(e)),{mode:r.mode,value:a,pads:o}}})(e.inputs,r);e.compute((o=e.inputs,u=d,i=e6.padShape(o[0].dims.slice(),u.pads),a=o[0].dims,n=[{type:12,data:e6.size(i)},{type:6,data:u.pads}],s=o.length>=3&&o[2].data,0===u.mode&&n.push({type:s?o[2].dataType:1,data:u.value}),n.push(...tE(o[0].dims,i)),{name:"Pad",shaderCache:{hint:`${u.mode}${s}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:i,dataType:o[0].dataType}],dispatchGroup:{x:Math.ceil(e6.size(i)/64)},programUniforms:n}),getShaderSource:e=>{let r=tN("output",o[0].dataType,i.length),n=tM("x",o[0].dataType,a.length),l=n.type.value,d=((e,r,i)=>{switch(i.mode){case 0:var a=e,n=r,s=i.pads.length;let o="";for(let e=n-1;e>=0;--e)o+=`
            k = i32(${a.indicesGet("indices",e)}) - ${tR("uniforms.pads",e,s)};
            if (k < 0) {
              break;
            }
            if (k >= i32(${tR("uniforms.x_shape",e,n)})) {
              break;
            }
            offset += k * i32(${tR("uniforms.x_strides",e,n)});
        `;return`
      ...
      `;case 1:var u=e,l=r,d=i.pads.length;let p="";for(let e=l-1;e>=0;--e)p+=`
                k = i32(${u.indicesGet("indices",e)}) - ${tR("uniforms.pads",e,d)};
                if (k < 0) {
                  k = -k;
                }
                {
                  let _2n_1 = 2 * (i32(${tR("uniforms.x_shape",e,l)}) - 1);
                  k = k % _2n_1;
                  if(k >= i32(${tR("uniforms.x_shape",e,l)})) {
                    k = _2n_1 - k;
                  }
                }
                offset += k * i32(${tR("uniforms.x_strides",e,l)});
            `;return`
              var offset = 0;
              var k = 0;
              ${p}
          ...
          `;case 2:var c=e,h=r,f=i.pads.length;let m="";for(let e=h-1;e>=0;--e)m+=`
                k = i32(${c.indicesGet("indices",e)}) - ${tR("uniforms.pads",e,f)};
                if (k < 0) {
                  k = 0;
                }
                if (k >= i32(${tR("uniforms.x_shape",e,h)})) {
                  k = i32(${tR("uniforms.x_shape",e,h)}) - 1;
                }
                offset += k * i32(${tR("uniforms.x_strides",e,h)});
            `;return`
              var offset = 0;
              var k = 0;
              ${m}
          ...
          `;case 3:var g=e,y=r,_=i.pads.length;let b="";for(let e=y-1;e>=0;--e)b+=`
                k = i32(${g.indicesGet("indices",e)}) - ${tR("uniforms.pads",e,_)};
                if (k < 0)  {
                  k += i32(${tR("uniforms.x_shape",e,y)}]);
                }
                if (k >= i32(${tR("uniforms.x_shape",e,y)})) {
                  k -= i32(${tR("uniforms.x_shape",e,y)});
                }
                offset += k * i32(${tR("uniforms.x_strides",e,y)});
            `;return`
              var offset = 0;
              var k = 0;
              ${b}
          ...
          `;default:throw Error("Invalid mode")}})(r,a.length,u),p=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:u.pads.length}];return 0===u.mode&&p.push({name:"constant_value",type:s?l:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},aq=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,aW=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),aL=(e,r,i,a)=>{let[n,s]=aD(r,a,i),o=tM("x",r.dataType,r.dims.length),u=o.type.value,l="";n.countIncludePad?l+=`value /= ${u}(uniforms.kernelSize);`:l+=`value /= ${u}(i32(uniforms.kernelSize) - pad);`;let[d,p,c,h,f]=aP(s,n);return d.push(...tE(r.dims,s)),{name:e,shaderCache:{hint:`${a.cacheKey};${c};${h};${f}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:s,dataType:r.dataType}],dispatchGroup:{x:Math.ceil(e6.size(s)/64)},programUniforms:d}),getShaderSource:e=>aU(e,o,r.dims.length,s.length,n,"value += x_val;",l,0,p,c,h,f)}},aV=e=>{let r,i=0!==e.count_include_pad,a=aW(e);if(0!==a.ceilMode)throw Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:i,...a,cacheKey:""};return{...n,cacheKey:(r=n,`${aq(r)};${r.countIncludePad}`)}},aG=(e,r)=>{aN(e.inputs),e.compute(aL("AveragePool",e.inputs[0],!1,r))},aH={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},aF=e=>{let r=e.format;return{format:r,...aH,cacheKey:r}},aj=(e,r)=>{aN(e.inputs),e.compute(aL("GlobalAveragePool",e.inputs[0],!0,r))},aK=(e,r,i,a)=>{let[n,s]=aD(r,a,i),o=`
      value = max(x_val, value);
    `,u=tM("x",r.dataType,r.dims.length),[l,d,p,c,h]=aP(s,n);return l.push(...tE(r.dims,s)),{name:e,shaderCache:{hint:`${a.cacheKey};${p};${c};${h}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:s,dataType:r.dataType}],dispatchGroup:{x:Math.ceil(e6.size(s)/64)},programUniforms:l}),getShaderSource:e=>aU(e,u,r.dims.length,s.length,n,o,"",10===r.dataType?-65504:-1e5,d,p,c,h)}},aZ=(e,r)=>{aN(e.inputs),e.compute(aK("MaxPool",e.inputs[0],!1,r))},aQ=e=>{let r,i=e.storage_order,a=e.dilations,n=aW(e);if(0!==i)throw Error("column major storage order is not yet supported for MaxPool");if(0!==n.ceilMode)throw Error("using ceil() in shape computation is not yet supported for MaxPool");let s={storageOrder:i,dilations:a,...n,cacheKey:""};return{...s,cacheKey:(r=s,`${aq(r)};${r.storageOrder};${r.dilations}`)}},aX=e=>{let r=e.format;return{format:r,...aH,cacheKey:r}},aY=(e,r)=>{aN(e.inputs),e.compute(aK("GlobalMaxPool",e.inputs[0],!0,r))}}),ss=V(()=>{ng(),nb(),nS(),nT(),aJ=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y,_,b,$,v,w,x,k,S,T,I;((e,r)=>{if(e.length<2||e.length>3)throw Error("DequantizeLinear requires 2 or 3 inputs.");if(3===e.length&&e[1].dims===e[2].dims)throw Error("x-scale and x-zero-point must have the same shape.");if(3===e.length&&e[0].dataType!==e[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(0!==e[1].dims.length&&1!==e[1].dims.length&&e[1].dims.length!==e[0].dims.length)throw Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((e,r)=>e&&r,!0))throw Error("scale and zero-point inputs must have the same shape.")}if(r.blockSize>0){if(0===e[1].dims.length||1===e[1].dims.length&&1===e[1].dims[0])throw Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((i,a)=>a===r.axis||i===e[0].dims[a]).reduce((e,r)=>e&&r,!0))throw Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[r.axis],a=e[1].dims[r.axis];if(r.blockSize<Math.ceil(i/a)||r.blockSize>Math.ceil(i/(a-1)-1))throw Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}})(e.inputs,r),e.compute((i=e.inputs,a=r,n=e6.normalizeAxis(a.axis,i[0].dims.length),o=3===(s=i[0].dataType),u=i[0].dims,l=i[1].dataType,d=e6.size(u),c=(p=3===s||2===s)?[Math.ceil(e6.size(i[0].dims)/4)]:i[0].dims,h=i[1].dims,m=(f=i.length>2?i[2]:void 0)?p?[Math.ceil(e6.size(f.dims)/4)]:f.dims:void 0,y=!1==(g=0===h.length||1===h.length&&1===h[0])&&1===h.length,_=tz(d),$=(b=g&&(!p||4===_))?_:1,v=tM("input",p?12:s,c.length,b&&!p?_:1),w=tM("scale",l,h.length),x=f?tM("zero_point",p?12:s,m.length):void 0,k=tN("output",l,u.length,$),S=[v,w],x&&S.push(x),T=[c,h],f&&T.push(m),I=[{type:12,data:d/$},{type:12,data:n},{type:12,data:a.blockSize},...tE(...T,u)],{name:"DequantizeLinear",shaderCache:{hint:a.cacheKey,inputDependencies:x?["rank","rank","rank"]:["rank","rank"]},getShaderSource:e=>`
      ...
      }`,getRunData:()=>({outputs:[{dims:u,dataType:l}],dispatchGroup:{x:Math.ceil(d/$/64),y:1,z:1},programUniforms:I})}))},a0=e=>tx({axis:e.axis,blockSize:e.blockSize})}),so=V(()=>{ed(),ng(),nT(),a1=e=>{var r,i,a,n;let s,o,u,l=0,d=0,p=0;6===e.inputs[0].dataType?(l=e.inputs[0].getInt32Array()[0],d=e.inputs[1].getInt32Array()[0],p=e.inputs[2].getInt32Array()[0]):1===e.inputs[0].dataType&&(l=e.inputs[0].getFloat32Array()[0],d=e.inputs[1].getFloat32Array()[0],p=e.inputs[2].getFloat32Array()[0]),h.webgpu.validateInputContent&&((e,r,i)=>{if(e===r||e<r&&i<0||e>r&&i>0)throw Error("Range these inputs' contents are invalid.")})(l,d,p),e.compute((r=l,i=d,a=p,n=e.inputs[0].dataType,o=[s=Math.abs(Math.ceil((i-r)/a))],u=[{type:12,data:s},{type:n,data:r},{type:n,data:a},...tE(o)],{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:e=>{let r=tN("output",n,o.length),i=r.type.value;return`
      ...
      }`},getRunData:()=>({outputs:[{dims:o,dataType:n}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}),{inputs:[]})}}),su=V(()=>{ng(),nb(),nS(),nT(),a2=e=>tx({reduction:e.reduction}),a3=(e,r)=>{var i,a;let n,s,o,u,l,d;e.compute((i=e.inputs,a=r,n=i[0].dims,s=i[1].dims,o=Math.ceil(e6.sizeToDimension(s,s.length-1)/1),u=s[s.length-1],l=e6.sizeFromDimension(n,u),d=[{type:12,data:o},{type:12,data:u},{type:12,data:l},...tE(i[1].dims,i[2].dims,n)],{name:"ScatterND",shaderCache:{hint:`${a.cacheKey}_${a.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:i[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:d}),getShaderSource:e=>{let r=tM("indices",i[1].dataType,i[1].dims.length),s=tM("updates",i[2].dataType,i[2].dims.length,1),o="none"!==a.reduction&&""!==a.reduction?tD("output",i[0].dataType,n.length):tN("output",i[0].dataType,n.length,1);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${((e,r,i,a)=>{if("none"!==e&&"i32"!==a&&"u32"!==a&&"f32"!==a)throw Error(`Input ${a} is not supported with reduction ${e}.`);let n=`{
      ...
      }`}}),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),sl=V(()=>{ng(),nb(),nS(),nT(),a4=(e,r,i,a)=>`
...
`:"",a8=(e,r)=>{var i,a,n,s,o,u,l,d,p,c,h,f;let m,g,y,_,b,$,v,w,x,k,S,T,I,E,z,C,A=[],O=[],R=[],B=new Uint32Array((m=e.customDataBuffer).buffer,m.byteOffset,1)[0];if(0!==r.antialias)throw Error("Only default value (0) for Antialias attribute is supported");((e,r,i,a,n,s)=>{let[o,u,l]=i>10?[1,2,3]:[-1,e.length>1?1:-1,-1],d=e[0].dims.length;if(o>0&&e.length>o&&e[o].dims.length>0)e[o].getFloat32Array().forEach(e=>s.push(e));else if("tf_crop_and_resize"===r.coordinateTransformMode)throw Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(u>0&&e.length>u&&1===e[u].dims.length&&e[u].dims[0]>0){var p,c,h;let n;if(e[u].getFloat32Array().forEach(e=>a.push(e)),0!==a.length&&a.length!==d&&i>=18&&a.length!==r.axes.length)throw Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");((e,r)=>{if(e.every(e=>e>0||(()=>{throw Error("Resize requires scales input values to be positive")})),e.length>0){if("linear"===r.mode){if(2!==e.length&&3!==e.length&&(4!==e.length||1!==e[0]||1!==e[1])&&(4!==e.length||1!==e[0]||1!==e[3])&&(5!==e.length||1!==e[0]||1!==e[1]))throw Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
     ...
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${i} { `+(()=>{switch(r){case"asymmetric":return`
          if (xScale < 1.0 || floor(xScale) != xScale) {
            ...
            ${a4("xResized","lengthOriginal","lengthResized",i)}
          }
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                    ...
                    ${a4("xResized","lengthOriginal - 1","lengthResized - 1",i)}
    ...
    fn calculateInputIndicesFromOutputIndices(output_indices: ${l.type.indices}) -> ${u.type.indices} {
      ...
      for (var i:u32 = 0; i < ${p.length}; i++) {
        ...
        if (scale == 1.0) {
          ...
          var roi_low = ${tR("uniforms.roi","i",h)};
          var roi_hi = ${tR("uniforms.roi",`i + ${d.length}`,h)};
...
`}
      }`},getRunData:()=>({outputs:[{dims:$,dataType:i.dataType}],dispatchGroup:{x:Math.ceil(T/64)},programUniforms:[{type:12,data:T},{type:1,data:v},{type:1,data:b},...tE(_,$)]})}),{inputs:[0]})},a5=e=>{let r=e.antialias,i=e.axes,a=e.coordinateTransformMode,n=e.cubicCoeffA,s=0!==e.excludeOutside,o=e.extrapolationValue,u=e.keepAspectRatioPolicy,l=e.mode,d=""===e.nearestMode?"simple":e.nearestMode;return tx({antialias:r,axes:i,coordinateTransformMode:a,cubicCoeffA:n,excludeOutside:s,extrapolationValue:o,keepAspectRatioPolicy:u,mode:l,nearestMode:d})}}),sd=V(()=>{ng(),nb(),nT(),a7=(e,r)=>{var i,a,n,s;let o,u,l,d,p,c,h,f,m,g,y,_,b;(e=>{if(!e||e.length<3)throw Error("layerNorm requires at least 3 inputs.");let r=e[0],i=e[1],a=e[2];if(r.dataType!==i.dataType||r.dataType!==a.dataType)throw Error("All inputs must have the same data type");if(3!==r.dims.length&&2!==r.dims.length)throw Error("Input must be 2D or 3D");if(3!==i.dims.length&&2!==i.dims.length)throw Error("Skip must be 2D or 3D");let n=r.dims[r.dims.length-1],s=r.dims[r.dims.length-2];if(i.dims[i.dims.length-1]!==n)throw Error("Skip must have the same hidden size as input");if(i.dims[i.dims.length-2]!==s)throw Error("Skip must have the same sequence length as input");if(1!==a.dims.length)throw Error("Gamma must be 1D");if(a.dims[a.dims.length-1]!==n)throw Error("Gamma must have the same hidden size as input");if(e.length>3){let r=e[3];if(1!==r.dims.length)throw Error("Beta must be 1D");if(r.dims[r.dims.length-1]!==n)throw Error("Beta must have the same hidden size as input")}if(e.length>4){let r=e[4];if(1!==r.dims.length)throw Error("Bias must be 1D");if(r.dims[r.dims.length-1]!==n)throw Error("Bias must have the same hidden size as input")}})(e.inputs);let $=[0];e.outputCount>1&&$.push(-3),e.outputCount>2&&$.push(-3),e.outputCount>3&&$.push(3),e.compute((i=e.inputs,a=r,n=e.outputCount,s=!1,o=a.simplified,u=i[0].dims,l=e6.size(u),d=u.slice(-1)[0],p=s?u.slice(0,-1).concat(1):[],c=!o&&i.length>3,h=i.length>4,f=s&&n>1,m=s&&n>2,g=n>3,_=[{type:12,data:l},{type:12,data:y=tz(d)},{type:12,data:d},{type:1,data:a.epsilon}],b=[{dims:u,dataType:i[0].dataType}],n>1&&b.push({dims:p,dataType:1}),n>2&&b.push({dims:p,dataType:1}),n>3&&b.push({dims:u,dataType:i[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${y};${f};${m};${g}`,inputDependencies:i.map((e,r)=>"type")},getShaderSource:e=>{let r=[tM("x",i[0].dataType,i[0].dims,y),tM("skip",i[1].dataType,i[1].dims,y),tM("gamma",i[2].dataType,i[2].dims,y)];c&&r.push(tM("beta",i[3].dataType,i[3].dims,y)),h&&r.push(tM("bias",i[4].dataType,i[4].dims,y)),r.push(tN("output",i[0].dataType,u,y)),f&&r.push(tN("mean_output",1,p)),m&&r.push(tN("inv_std_output",1,p)),g&&r.push(tN("input_skip_bias_sum",i[0].dataType,u,y));let a=tT(i[0].dataType),n=tT(1,y);return`
      ...
      }`},getRunData:()=>({outputs:[p],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:g})}})(e.inputs,n),{inputs:[0]})},nr=e=>{let r=e.starts,i=e.ends,a=e.axes;return tx({starts:r,ends:i,axes:a})}}),sc=V(()=>{ng(),nb(),nS(),nI(),nT(),ni=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y,_,b,$,v,w,x;(e=>{if(!e||1!==e.length)throw Error("Softmax op requires 1 input.")})(e.inputs),i=e,a=r,s=(n=i.inputs[0]).dims,o=e6.size(s),u=s.length,d=(l=e6.normalizeAxis(a.axis,u))<s.length-1,c=[],d?((c=Array.from({length:u},(e,r)=>r))[l]=u-1,c[u-1]=l,p=i.compute(tL(n,c),{inputs:[n],outputs:[-1]})[0]):p=n,m=o/(f=(h=p.dims)[u-1]),g=tz(f),y=f/g,_=64,1===m&&(_=256),b=tM("x",p.dataType,p.dims,g),$=tN("result",p.dataType,p.dims,g),v=b.type.value,w="f32"===tT(p.dataType)?`var threadMax = ${v}(-3.4028234663852886e+38f);`:`var threadMax = ${v}(-65504.0h);`,x=i.compute({name:"Softmax",shaderCache:{hint:`${g};${_}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:h,dataType:p.dataType}],dispatchGroup:{x:m},programUniforms:[{type:6,data:y}]}),getShaderSource:e=>{let r;return`
      ...
      ${e.mainStart(_)}
        ...
        if (lindex == 0) {
          rowSumShared = ${v}(${tO("threadShared[0]",g)});
        }
        workgroupBarrier();
      ...
      }`}},{inputs:[p],outputs:[d?-1:0]})[0],d&&i.compute(tL(x,c),{inputs:[x]})},na=e=>tx({axis:e.axis})}),sh=V(()=>{ng(),nb(),nT(),nn=e=>Array.from(e.getBigInt64Array(),Number),ns=e=>{var r;let i,a,n,s,o,u,l;(e=>{if(!e||2!==e.length)throw Error("Tile requires 2 inputs.");if(1!==e[0].dataType&&10!==e[0].dataType&&6!==e[0].dataType&&12!==e[0].dataType)throw Error("Tile only support float, float16, int32, and uint32 data types");if(7!==e[1].dataType)throw Error("Tile `repeats` input should be of int64 data type");if(1!==e[1].dims.length)throw Error("Tile `repeats` input should be 1-D");if(nn(e[1]).length!==e[0].dims.length)throw Error("Tile `repeats` input should have same number of elements as rank of input data tensor")})(e.inputs),e.compute((i=(r=e.inputs)[0].dims,n=((e,r)=>{let i=[];for(let a=0;a<e.length;++a)i.push(e[a]*r[a]);return i})(i,a=(void 0)??nn(r[1])),s=e6.size(n),o=r[0].dataType,u=tM("input",o,i.length),l=tN("output",o,n.length),{name:"Tile",shaderCache:{hint:`${a}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:n,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:[{type:12,data:s},...tE(r[0].dims,n)]}),getShaderSource:e=>`
    ...
    }`}),{inputs:[0]})}}),sf=V(()=>{ng(),nb(),nT(),no=e=>{e.compute((e=>{let r=e[1].dims,i=e[2].dims,a=e[0].dims,n=e[1].dataType,s=!(e6.areEqual(r,i)&&e6.areEqual(i,a)),o=r,u=e6.size(r);if(s){let e=e4.calcShape(e4.calcShape(r,i,!1),a,!1);if(!e)throw Error("Can't perform where op on the given tensors");o=e,u=e6.size(o)}let l=Math.ceil(u/4);return{name:"Where",shaderCache:{inputDependencies:["rank","rank","rank"]},getShaderSource:r=>((e,r,i,a,n)=>{let s=tN("output_data",n,i.length,4),o=tM("a_data",r[1].dataType,r[1].dims.length,4),u=tM("b_data",r[2].dataType,r[2].dims.length,4),l=tM("c_data",r[0].dataType,r[0].dims.length,4),d,p=(e,r,i)=>`select(${r}, ${e}, ${i})`;if(a){let e=(e,r,i="")=>{let a=`a_data[index_a${r}][component_a${r}]`,n=`b_data[index_b${r}][component_b${r}]`,d=`bool(c_data[index_c${r}] & (0xffu << (component_c${r} * 8)))`;return`
