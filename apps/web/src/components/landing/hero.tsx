    ...
    <section className="relative border-b border-border">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 py-24 sm:py-32">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
          SoulVault keeps agent swarms alive across ephemeral sessions, and lets
          humans and agents share sensitive documents through ordinary channels.
          Fields are redacted locally and reconstructed only by wallets that are
