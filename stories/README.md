...
- `story08.md` — fund request flow + org-level pause: organization deploy, swarm registry, agent requests funds, org owner approves/rejects, pause/unpause freezes all swarms, mutual-consent + failure modes
