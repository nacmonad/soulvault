...
**Resolution path:** Submit ERC-7730 descriptors to `github.com/LedgerHQ/clear-signing-erc7730-registry`. Until merged, Speculos uses `packages/node/test/speculos/cal/*.json` and hardware documents expected bytes in the operator checklist.
