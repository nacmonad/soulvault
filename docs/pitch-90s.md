...
First, it backs up critical agent markdown state — files like `SOUL.md`, `MEMORY.md`, and `HEARTBEAT.md` — encrypts everything client-side, and stores only ciphertext on IPFS.
